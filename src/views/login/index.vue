<template>
    <div class="main">
        <div class="box right">
            ...
            <div class="bmg">
                <p>Please, upgrade your dependencies to the actual version of core-js</p>
                <img src="../../assets/images/login.png" alt="" style="width: 500px;">
            </div>
        </div>
        <div class="box left">
            <h1>欢迎登录</h1>
            <div class="login form">
                <form action="#">
                    ...
                    <button @click="login" type="button">立即登录</button>
                </form>
            </div>
            <div class="register">
...
export default {
    ...
    methods: {
        login(){
            console.log("登录",this.name,this.password)
        }
    }
}
</script>
